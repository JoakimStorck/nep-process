...
minut; f6-256-skala kostar drygt två minuter i uppstart (135 s uppmätt i
sandlådan i 0199, inte ommätt på den här maskinen) plus ~70 ms/tick
(p198: 40 000 tick på 2848 s), så
